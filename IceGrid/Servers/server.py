...
class RoomManagment(IceGauntlet.RoomManager):
    ...
    def __init__(self, proxy_auth_server, server_sync, almacen_mapas, name):
...
class Server(Ice.Application):
    ...
    def run(self, argv):
        ...
        servantrm = RoomManagment(broker.propertyToProxy('Auth_Server'),
        servantRoomSync, almacenRoom, properties.getProperty('Ice.ProgramName'))

        idRM__ = properties.getProperty('Identity')
        proxyrm = adapterrm.add(servantrm, broker.stringToIdentity(idRM__))
